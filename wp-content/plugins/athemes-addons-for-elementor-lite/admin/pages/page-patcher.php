...
<style>
    ...
    .addons-dashboard-alert p {
        margin: 0
    }

    .addons-dashboard-alert.addons-dashboard-alert-with-icon {
        position: relative;
        padding-left: 50px
    }

    .addons-dashboard-alert.addons-dashboard-alert-with-icon .alert-icon {
        position: absolute;
        top: 21px;
        left: 20px;
        max-width: 17px
    ...
    .addons-dashboard-alert.addons-dashboard-alert-with-icon .alert-icon svg {
        width: 100%;
        height: auto
    }

    .addons-dashboard-alert.addons-dashboard-alert-with-upsell-link {
        padding-right: 160px
    }

    .addons-dashboard-alert.addons-dashboard-alert-with-upsell-link .addons-dashboard-external-link {
        position: absolute;
        top: 22px;
        right: 20px
    }

    .addons-dashboard-external-link {
    ...
    .addons-dashboard-external-link svg {
        position: relative;
        top: 1px
    }

    .addons-dashboard-external-link:hover,.addons-dashboard-external-link:focus,.addons-dashboard-external-link:active {
        color: #3858e9;
        opacity: .7
    }
    ...
    .addons-dashboard-pro-tooltip {
        position: relative
    }

    .addons-dashboard-pro-tooltip:before {
    ...
    .addons-dashboard-pro-tooltip:after {
        content: "";
        position: absolute;
        bottom: calc(100% + 3px);
        left: 50%;
    ...
    .addons-dashboard-pro-tooltip:hover:before,.addons-dashboard-pro-tooltip:hover:after {
        opacity: 1;
        visibility: visible;
...
<div id="athemes-patcher-options-page">
    <?php if ( ! defined( 'ATHEMES_AFE_PRO_VERSION' ) ) : ?>
        <div class="addons-dashboard-alert addons-dashboard-alert-warning addons-dashboard-alert-with-icon addons-dashboard-alert-with-upsell-link">
            ...
            <p class="bt-text-color-grey"><?php echo esc_html__( 'Please note this feature is available only in aThemes Addons Pro', 'athemes-addons-for-elementor-lite' ); ?></p>
            <a href="https://athemes.com/addons?utm_source=athemes-patcher&utm_medium=link&utm_campaign=aThemes Addons" class="addons-dashboard-external-link" target="_blank">
                <?php echo esc_html__( 'Upgrade Now', 'athemes-addons-for-elementor-lite' ); ?>
    ...
    <div data-wp-c16t="true" data-wp-component="Card" class="components-surface components-card athemes-patcher-card css-1hdyajo css-1otwcjs e19lxcc00">
        <div class="css-10klw3m e19lxcc00">
            <h3 class="athemes-patcher-card-title">aThemes Addons Pro</h3>
            <p class="athemes-patcher-card-desc">The following patches are available for the version <?php echo esc_html( ATHEMES_AFE_VERSION ); ?></p>
                ...
                <table class="athemes-patchers-table css-18si9r1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php if ( defined( 'ATHEMES_AFE_PRO_VERSION' ) && ! defined( 'ATHEMES_PATCHER_VERSION' ) ) : ?>
                                    <a class="components-button has-lock-icon css-adm54n addons-dashboard-pro-tooltip addons-install-plugin" href="https://athemes.com/addons?utm_source=athemes-patcher&utm_medium=link&utm_campaign=aThemes Addons" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This will install and activate the aThemes Patcher plugin', 'athemes-addons-for-elementor-lite' ); ?>" data-type="external" data-plugin-url="https://patcher.athemes.com/athemes-patcher.zip?nocache=<?php echo esc_attr( time() ); ?>" data-plugin-name="athemes-patcher/athemes-patcher.php" data-redirect-to="<?php echo esc_url( add_query_arg('page', 'athemes-patcher-ap', admin_url('admin.php')) ); ?>">
                                        Install Patcher
                                    </a>
                                <?php else : ?>
                                    <a class="components-button has-lock-icon css-adm54n addons-dashboard-pro-tooltip" href="https://athemes.com/addons?utm_source=athemes-patcher&utm_medium=link&utm_campaign=aThemes Addons" target="_blank" data-tooltip-message="<?php echo esc_attr__( 'This is only available on aThemes Addons Pro', 'athemes-addons-for-elementor-lite' ); ?>">
                                        Apply
